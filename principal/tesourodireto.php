...
<body>
  <div class="container-fluid">
    ...
    <div class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link" href="orgfinpes.php">Equilibrar as contas</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="tesourodireto.php">Tesouro direto</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="rendafixa.php">Renda fixa</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="rendavariavel">Renda variável</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="pagina.php?id=5">Serviços virtuais</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="row">
    <div class="col-12">
      <img class="d-none d-md-block mx-auto img-fluid" src="http://via.placeholder.com/728x300">
  ...
  <div class="col-12 artigos">
    <h1>Equilibrar as Contas</h1>
  </div>
</div>
<div class="row secoes">
  <div class="col-sm-6">
    <?php
    require_once("tesourodireto-pesquisa.php"); 
    $art1   = $eqcontas[0];
    $id     = $art1['id'];
    $autor  = $art1['autor'];
    $data   = $art1['data'];
    ...
    <div class="card img-box border-0">
      <a href="pagina.php?id=<?php echo $id; ?>">
        <img class="card-img-top img-fluid rounded" src="../img/<?php echo $imagem;?>.png">
